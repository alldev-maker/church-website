...
module.exports = {
  /* 01.General */
  'general.copyright': 'Church Notes © 2022 All Rights Reserved.',
  ...
  'user.login-with-google-button': 'Sign in with Google',
  'user.login-with-apple-button': 'Sign in with Apple',
